...
private:
   ...
   void appendRasterEntry(ossimKeywordlist &kwl,
                          const ossimString &prefix = ossimString("")) const;
   void appendRasterEntries(ossimKeywordlist &kwl,
                            const ossimString &prefix = ossimString("")) const;
   ...
   void appendAssociatedFiles(std::string &outputString,
                              const std::string &indentation,
                              const std::string &separator) const;
   void appendAssociatedFiles(ossimKeywordlist &kwl,
                              const ossimString &prefix = ossimString("")) const;

   void appendAssociatedRasterEntryFileObjects(std::string &outputString,
                                               const std::string &indentation,
                                               const std::string &separator) const;
   void appendAssociatedRasterEntryFileObjects(ossimKeywordlist &kwl,
                                               const ossimString &prefix = ossimString("")) const;
   void appendBitDepthAndDataType(ossimKeywordlist &kwl,
                                  const ossimString &prefix = ossimString("")) const;
   void appendBitDepthAndDataType(std::string &outputString,
                                  const std::string &indentation,
                                  const std::string &separator) const;
   void appendGeometryInformation(ossimKeywordlist &kwl,
                                  const ossimString &prefix = ossimString("")) const;
   ...
   void appendVideoDataSetMetadata(std::string &outputString,
                                   const std::string &indentation,
                                   const std::string &separator) const;
   void appendRasterEntryDateTime(ossimKeywordlist &kwl,
                                  const ossimString &prefix) const;
   void appendRasterEntryDateTime(std::string &outputString,
                                  const std::string &indentation,
                                  const std::string &separator) const;

   void appendRasterEntryMetadata(
